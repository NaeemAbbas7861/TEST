...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["signup-signup-module"], {
  ...
  function srcAppSignupSignupModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _ionic_native_file_chooser_ngx__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    var _signup_page__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./signup.page */
  ...
  function srcAppSignupSignupPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _infomodal_infomodal_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    var SignupPage = /*#__PURE__*/function () {
      function SignupPage(fun, menuCtrl, modalController, data, formBuilder, loginservice, storage, router, toasterservice, loadingController, ref, file, fileChooser, transfer, filePath) {
        ...
        this.filePath = filePath; // first_name = '';
        // last_name = '';
        // email = '';
        ...
        this.validation_messages = {
          ...
          mobileNumber: [{
            ...
            type: "pattern",
            message: "Contact Number is required like 03xxxxxxxxx and length 11 char"
          }],
          CNIC: [{
            type: "required",
            ...
            type: "pattern",
            message: "CNIC number is required without dashes"
          }],
          Address: [{
            type: "required",
      ...
      _createClass(SignupPage, [{
        ...
        value: function ngOnInit() {
          this.fg = this.formBuilder.group({
            ...
            'CNIC': [],
            'CNIC_Image': [],
            'Email_Address': [null, _angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].pattern("^[_A-Za-z0-9-\\+]+(\\.[_A-Za-z0-9-]+)*@[A-Za-z0-9-]+(\\.[A-Za-z0-9]+)*(\\.[A-Za-z]{2,})$")])],
            'Address': [null, _angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].required],
            'Contact_Number': [null, _angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].pattern("^0[03][0-9]{9}$")])],
        ...
        key: "checkCNIC",
        value: function checkCNIC() {
          if (this.fg.value.RoleId == 2 || this.fg.value.RoleId == 4) {
            this.fg.controls['CNIC'].setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].pattern("[0-9]{13}$")]));
          } else this.fg.controls['CNIC'].setValidators(null);
        }
      }, {
        key: "ionViewDidEnter",
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 54:
                    if (!(this.fg.value.RoleId == 2 && this.fg.value.CNIC_Image == null)) {
                      _context.next = 58;
                      break;
                    }
                  ...
                  case 58:
                    if (!(this.fg.value.RoleId == 4 && this.fg.value.CNIC_Image == null)) {
                      _context.next = 62;
                      break;
                    }
                  ...
                  case 68:
                    _context.next = 70;
                    return this.loginservice.SignUp(obj).subscribe(function (res) {
                      if (res) {
                        _this.storage.set("username", obj); // this.storage.set(environment.USER, res);


                        loading.dismiss();

                        _this.router.navigate(['/otpverify/' + res.id]);

                        _this.storage.set("userid", res.id);
                      } else {
                        loading.dismiss();

                        _this.toasterservice.create("exception", 'danger');
                      }
                    }, function (err) {
                      loading.dismiss();
                      ...
                      if (err.indexOf('unverified') != -1) {
                        ...
                        _this.router.navigate(['/otpverify/' + res]);
                      } else _this.toasterservice.create(err, 'danger');
                                  ...
                                  switch (_context3.prev = _context3.next) {
                                    case 0:
                                      ...
                                      return fileTransfer.upload(uri, src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].BASE_URL + 'upload', options).then(function (data) {
                                        // success
                                        _this4.toasterservice.create("successfully Uploaded");

                                        _this4.uploading = false;
                                        var dbpath = JSON.parse(data.response);
                                        _this4.fg.value.CNIC_Image = dbpath.dbPath;

                                        _this4.ref.detectChanges(); //console.log(this.fg.value.cniC_Image);
