...
/* harmony import */ var _editgroup_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editgroup.page */ "./src/app/superAdmin/group/edit/editgroup.page.ts");
...
let EditGroupPage = class EditGroupPage {
    constructor(router, route, groupservice, loadingController, toastService, formBuilder, http
    ...
    EditGroup() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            if (obj.Name.length == 0) {
                ...
                const loading = yield this.loadingController.create({ message: "Loading" });
                yield loading.present();
                yield this.groupservice.EditGroup(this.id, this.fg.value).subscribe(res => {
                    loading.dismiss();
...
EditGroupPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./editgroup.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/superAdmin/group/edit/editgroup.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./editgroup.page.scss */ "./src/app/superAdmin/group/edit/editgroup.page.scss")).default]
    })
], EditGroupPage);
...
//# sourceMappingURL=edit-editgroup-module-es2015.js.map