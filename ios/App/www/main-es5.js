...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function $$_lazy_route_resourceLazyRecursive(module, exports, __webpack_require__) {
    var map = {
      "./Viewshops/Viewshops.module": ["./src/app/superAdmin/shop/Viewshops/Viewshops.module.ts", "Viewshops-Viewshops-module"],
      "./accountsettings/accountsettings.module": ["./src/app/accountsettings/accountsettings.module.ts", "default~accountsettings-accountsettings-module~add-addproduct-module~add-addshop-module~checkout-che~4c19ecff", "common", "accountsettings-accountsettings-module"],
      "./add/addcategory.module": ["./src/app/superAdmin/group/category/add/addcategory.module.ts", "common", "add-addcategory-module"],
      "./add/addclassification.module": ["./src/app/superAdmin/group/category/classification/add/addclassification.module.ts", "common", "add-addclassification-module"],
      "./add/addgroup.module": ["./src/app/superAdmin/group/add/addgroup.module.ts", "common", "add-addgroup-module"],
      "./add/addprodcut.module": ["./src/app/superAdmin/return-product/add/addprodcut.module.ts", "add-addprodcut-module"],
      "./add/addproduct.module": ["./src/app/shopOwner/shop/product/add/addproduct.module.ts", "default~accountsettings-accountsettings-module~add-addproduct-module~add-addshop-module~checkout-che~4c19ecff", "common", "add-addproduct-module"],
      "./add/addshop.module": ["./src/app/shopOwner/shop/add/addshop.module.ts", "default~accountsettings-accountsettings-module~add-addproduct-module~add-addshop-module~checkout-che~4c19ecff", "default~add-addshop-module~checkout-checkout-module~edit-editshop-module~home-home-module~rider-ride~e78bef5b", "common", "add-addshop-module"],
      "./approved/approved.module": ["./src/app/superAdmin/shop/approved/approved.module.ts", "approved-approved-module"],
      "./approved/approvedrider.module": ["./src/app/superAdmin/ridersadmin/approved/approvedrider.module.ts", "common", "approved-approvedrider-module"],
      "./cart/cart.module": ["./src/app/cart/cart.module.ts", "cart-cart-module"],
      "./category/category.module": ["./src/app/superAdmin/group/category/category.module.ts", "common", "category-category-module"],
      ...
      "./checkout/checkout.module": ["./src/app/checkout/checkout.module.ts", "default~accountsettings-accountsettings-module~add-addproduct-module~add-addshop-module~checkout-che~4c19ecff", "default~add-addshop-module~checkout-checkout-module~edit-editshop-module~home-home-module~rider-ride~e78bef5b", "checkout-checkout-module"],
      "./classification/classification.module": ["./src/app/superAdmin/group/category/classification/classification.module.ts", "common", "classification-classification-module"],
      "./dashboard/dashboard.module": ["./src/app/rider/dashboard/dashboard.module.ts", "common", "dashboard-dashboard-module"],
      "./datacontrol/datacontrol.module": ["./src/app/datacontrol/datacontrol.module.ts", "datacontrol-datacontrol-module"],
      "./earning/earning.module": ["./src/app/superAdmin/earning/earning.module.ts", "default~earning-earning-module~shopearning-shopearning-module", "earning-earning-module"],
      "./edit/editcategory.module": ["./src/app/superAdmin/group/category/edit/editcategory.module.ts", "common", "edit-editcategory-module"],
      "./edit/editclassification.module": ["./src/app/superAdmin/group/category/classification/edit/editclassification.module.ts", "common", "edit-editclassification-module"],
      "./edit/editgroup.module": ["./src/app/superAdmin/group/edit/editgroup.module.ts", "common", "edit-editgroup-module"],
      "./edit/editprodcut.module": ["./src/app/superAdmin/return-product/edit/editprodcut.module.ts", "edit-editprodcut-module"],
      "./edit/editproduct.module": ["./src/app/shopOwner/shop/product/edit/editproduct.module.ts", "default~accountsettings-accountsettings-module~add-addproduct-module~add-addshop-module~checkout-che~4c19ecff", "common", "edit-editproduct-module"],
      "./edit/editshop.module": ["./src/app/shopOwner/shop/edit/editshop.module.ts", "default~accountsettings-accountsettings-module~add-addproduct-module~add-addshop-module~checkout-che~4c19ecff", "default~add-addshop-module~checkout-checkout-module~edit-editshop-module~home-home-module~rider-ride~e78bef5b", "common", "edit-editshop-module"],
      "./faq/faq.module": ["./src/app/faq/faq.module.ts", "common", "faq-faq-module"],
      "./faqs/faqs.module": ["./src/app/faqs/faqs.module.ts", "common", "faqs-faqs-module"],
      "./group/group.module": ["./src/app/superAdmin/group/group.module.ts", "common", "group-group-module"],
      "./home/home.module": ["./src/app/home/home.module.ts", "default~add-addshop-module~checkout-checkout-module~edit-editshop-module~home-home-module~rider-ride~e78bef5b", "common", "home-home-module"],
      "./items/item.module": ["./src/app/shopOwner/order/items/item.module.ts", "items-item-module"],
      "./items/items.module": ["./src/app/rider/riderOrder/items/items.module.ts", "items-items-module"],
      "./items/view-item.module": ["./src/app/superAdmin/view-orders/items/view-item.module.ts", "items-view-item-module"],
      "./list-of-product/list-of-product.module": ["./src/app/shopOwner/list-of-product/list-of-product.module.ts", "list-of-product-list-of-product-module"],
      "./login/login.module": ["./src/app/login/login.module.ts", "common", "login-login-module"],
      "./managepayments/managepayments.module": ["./src/app/managepayments/managepayments.module.ts", "managepayments-managepayments-module"],
      "./newpayment/newpayment.module": ["./src/app/newpayment/newpayment.module.ts", "newpayment-newpayment-module"],
      "./order/order.module": ["./src/app/shopOwner/order/order.module.ts", "order-order-module"],
      "./orderinfo/orderinfo.module": ["./src/app/orderinfo/orderinfo.module.ts", "common", "orderinfo-orderinfo-module"],
      "./orders/orders.module": ["./src/app/orders/orders.module.ts", "common", "orders-orders-module"],
      "./otp_verify/otp_verify.module": ["./src/app/otp_verify/otp_verify.module.ts", "common", "otp_verify-otp_verify-module"],
      "./otp_verify/otp_verifyreset.module": ["./src/app/passwordreset/otp_verify/otp_verifyreset.module.ts", "common", "otp_verify-otp_verifyreset-module"],
      "./passwordreset/passwordreset.module": ["./src/app/passwordreset/passwordreset.module.ts", "common", "passwordreset-passwordreset-module"],
      "./product/adminproduct.module": ["./src/app/superAdmin/shop/product/adminproduct.module.ts", "product-adminproduct-module"],
      "./product/product.module": ["./src/app/shopOwner/shop/product/product.module.ts", "product-product-module"],
      "./productdetail/productdetail.module": ["./src/app/productdetail/productdetail.module.ts", "productdetail-productdetail-module"],
      "./productlist/productlist.module": ["./src/app/productlist/productlist.module.ts", "default~productlist-productlist-module~shopproducts-shopproducts-module", "productlist-productlist-module"],
      "./return-product/return-product.module": ["./src/app/superAdmin/return-product/return-product.module.ts", "return-product-return-product-module"],
      "./rider/rider.module": ["./src/app/rider/rider.module.ts", "default~add-addshop-module~checkout-checkout-module~edit-editshop-module~home-home-module~rider-ride~e78bef5b", "rider-rider-module"],
      "./riderOrder/riderOrder.module": ["./src/app/rider/riderOrder/riderOrder.module.ts", "default~add-addshop-module~checkout-checkout-module~edit-editshop-module~home-home-module~rider-ride~e78bef5b", "riderOrder-riderOrder-module"],
      "./ridersadmin/ridersadmin.module": ["./src/app/superAdmin/ridersadmin/ridersadmin.module.ts", "ridersadmin-ridersadmin-module"],
      "./settings/settings.module": ["./src/app/settings/settings.module.ts", "settings-settings-module"],
      "./shop/ownershop.module": ["./src/app/shopOwner/shop/ownershop.module.ts", "shop-ownershop-module"],
      "./shop/shop.module": ["./src/app/superAdmin/shop/shop.module.ts", "shop-shop-module"],
      "./shopOwner/shopowner.module": ["./src/app/shopOwner/shopowner.module.ts", "common", "shopOwner-shopowner-module"],
      "./shopearning/shopearning.module": ["./src/app/superAdmin/shopearning/shopearning.module.ts", "default~earning-earning-module~shopearning-shopearning-module", "shopearning-shopearning-module"],
      "./shopproducts/shopproducts.module": ["./src/app/shopproducts/shopproducts.module.ts", "default~productlist-productlist-module~shopproducts-shopproducts-module", "shopproducts-shopproducts-module"],
      "./signup/signup.module": ["./src/app/signup/signup.module.ts", "default~accountsettings-accountsettings-module~add-addproduct-module~add-addshop-module~checkout-che~4c19ecff", "common", "signup-signup-module"],
      "./splashscreen/splashscreen.module": ["./src/app/splashscreen/splashscreen.module.ts", "splashscreen-splashscreen-module"],
      "./superAdmin/group/group.module": ["./src/app/superAdmin/group/group.module.ts", "common", "group-group-module"],
      "./superAdmin/superadmin.module": ["./src/app/superAdmin/superadmin.module.ts", "common", "superAdmin-superadmin-module"],
      "./terms/terms.module": ["./src/app/terms/terms.module.ts", "terms-terms-module"],
      "./unapproved/unapproved.module": ["./src/app/superAdmin/shop/unapproved/unapproved.module.ts", "unapproved-unapproved-module"],
      "./unapproved/unapprovedrider.module": ["./src/app/superAdmin/ridersadmin/unapproved/unapprovedrider.module.ts", "common", "unapproved-unapprovedrider-module"],
      "./user/user.module": ["./src/app/superAdmin/user/user.module.ts", "common", "user-user-module"],
      "./view-orders/view-orders.module": ["./src/app/superAdmin/view-orders/view-orders.module.ts", "view-orders-view-orders-module"],
      "./wishlist/wishlist.module": ["./src/app/wishlist/wishlist.module.ts", "wishlist-wishlist-module"]
    };
  ...
  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/infomodal/infomodal.page.html":
  /*!*************************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/infomodal/infomodal.page.html ***!
    \*************************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppInfomodalInfomodalPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "<!-- /**\r\n * Shoppr - E-commerce app starter Ionic 4(https://www.enappd.com)\r\n *\r\n * Copyright © 2018-present Enappd. All rights reserved.\r\n *\r\n * This source code is licensed as per the terms found in the\r\n * LICENSE.md file in the root directory of this source .\r\n */ -->\r\n\r\n<ion-header>\r\n  <ion-toolbar color=\"mytheme\">\r\n    <ion-title color=\"light\">{{title}}</ion-title>\r\n    <ion-buttons slot=\"end\">\r\n      <ion-icon name=\"close\" color=\"light\" slot=\"icon-only\" (click)=\"dismiss()\" size=\"large\"></ion-icon>\r\n    </ion-buttons>\r\n  </ion-toolbar>\r\n\r\n</ion-header>\r\n\r\n<ion-content padding>\r\n\r\n  <div class=\"textSection\">\r\n      {{value}}\r\n  </div>\r\n\r\n</ion-content>\r\n";
    /***/
  },
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      path: 'managepayments',
      loadChildren: './managepayments/managepayments.module#ManagepaymentsPageModule'
    }, {
      path: 'newpayment',
      ...
      loadChildren: './accountsettings/accountsettings.module#AccountsettingsPageModule'
    }, {
      path: 'changepassword',
      loadChildren: './changepassword/changepassword.module#ChangepasswordPageModule'
    }, {
      path: 'shopproducts/:id',
      loadChildren: './shopproducts/shopproducts.module#ShopProductsPageModule'
    }, {
      path: 'otpverify/:id',
      loadChildren: './otp_verify/otp_verify.module#OtpverifyPageModule'
    }, {
      path: 'superadmingroup',
      loadChildren: './superAdmin/group/group.module#GroupPageModule'
    }, {
      path: 'superadmin',
      loadChildren: './superAdmin/superadmin.module#SuperAdminPageModule'
    }, {
      path: 'shopowner',
      loadChildren: './shopOwner/shopowner.module#ShopOwnerPageModule'
    }, {
      path: 'rider',
      loadChildren: './rider/rider.module#RiderPageModule'
    }, {
      path: 'splashscreen',
  ...
  /***/
  "./src/app/app.component.page.scss":
  /*!*****************************************!*\
    !*** ./src/app/app.component.page.scss ***!
    \*****************************************/
  ...
  /***/
  function srcAppAppComponentPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = ".active {\n  color: #DB9E07;\n}\n\n.notactive {\n  color: black;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _functions_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./functions.service */
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(platform, statusBar, dataService, fun, sharedservice, storage, route, location, alertController) {
        ...
        this.RESOURCE = src_environments_environment__WEBPACK_IMPORTED_MODULE_9__["environment"].RESOURCE_URL; // if (this.sharedservice.user) {
        // this.appPages = [
        ...
        this.appPages1 = [//  { title: 'Customer Support', url: '/support', icon: 'people' },
        {
          title: 'FAQs',
          url: '/faqs',
          icon: 'help-circle'
        ...
        this.colors = ['Bronze', 'Black', 'Blue', 'Clear', 'Gold', 'Gray', 'Green', 'Multi-Color', 'Orange', 'Pink', 'Red', 'Silver', 'White', 'Yellow', 'Brown', 'Purple', 'Beige'];
        this.route.navigateByUrl('/splashscreen');
        this.initializeApp(); // this.backButtonEvent();
      }

      _createClass(AppComponent, [{
        key: "menu",
        value: function menu(b) {
          if (b) {
        ...
        value: function ionViewDidEnter() {
          ...
          this.storage.get("User").then(function (value) {
            if (value) {
              _this.sharedservice.UpdateUser(value);

              _this.sharedservice.updatelogin(true);
        ...
        value: function initializeApp() {
          ...
          this.storage.get("User").then(function (value) {
            if (value) {
              _this2.sharedservice.UpdateUser(value);

              _this2.sharedservice.updatelogin(true);
        ...
        value: function logout() {
          ...
          this.sharedservice.user.FirstName = "Guest";
          this.sharedservice.user.LastName = "User";
    ...
    AppComponent.ctorParameters = function () {
      return [{
        ...
        type: _functions_service__WEBPACK_IMPORTED_MODULE_6__["FunctionsService"]
      }, {
    ...
    AppComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      /*! ./app.component.page.scss */
      "./src/app/app.component.page.scss"))["default"]]
    })], AppComponent);
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _infomodal_infomodal_page__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    ...
    AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_7__["AppComponent"], _infomodal_infomodal_page__WEBPACK_IMPORTED_MODULE_9__["InfomodalPage"]],
      entryComponents: [_infomodal_infomodal_page__WEBPACK_IMPORTED_MODULE_9__["InfomodalPage"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_10__["HttpClientModule"], _ionic_storage__WEBPACK_IMPORTED_MODULE_11__["IonicStorageModule"].forRoot(), _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_12__["BrowserAnimationsModule"]],
  ...
  function srcAppDataServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DataService = function DataService() {
      ...
      this.card = {
        ...
        title: 'Kya aapne kabhi online Batteries book kia hai???\nHotel? Sastago',
        time: 9
      };
      this.notifications = {
      ...
      //   { name: 'Scarlett Dress', cost_price: 218, discount: 80, offer: false, stock: 69, description: 'sample data', image: ['assets/images/products/5.jpg', 'assets/images/products/5_1.jpg', 'assets/images/products/5_2.jpg'], rating_count: 11, store_rating_count: 11, currency: '$', bought: 234, size: 'M', color: 'Black', shipping: 250, rating: 4, store_rating: 18090, store_rate: 3, sold_by: 'seller', specs: 'this is a sample product', reviews: [{ image: 'assets/images/products/5.jpg', name: 'sample', comment: 'This is an amazing dress and totally out of budget. Need to sell my only kidney to purchase this one as other kidney is already sold for my iphone...lol', rating: 5, images: ['assets/images/products/5.jpg'] }], store_reviews: [{ image: 'assets/images/products/5_1.jpg', name: 'sample', comment: 'This is an amazing dress and totally out of budget. Need to sell my only kidney to purchase this one as other kidney is already sold for my iphone...lol', rating: 5, images: ['assets/images/products/5.jpg', 'assets/images/products/5_1.jpg'] }, { image: 'assets/images/products/5.jpg', name: 'sample', comment: 'This is an amazing dress and totally out of budget. Need to sell my only kidney to purchase this one as other kidney is already sold for my iphone...lol', rating: 5, images: ['assets/images/products/5.jpg'] }], sizing: { small: 10, okay: 80, large: 5 }, buyer_guarantee: 'Return all products within 30 days of delivery if they are not up to your satisfaction', sponsored: [] },
      //   ];
      // products_2: Array<Product> = [{ name: 'Morrisson Dress', cost_price: 128, discount: 80, offer: false, stock: 69, description: 'sample data', image: ['assets/images/products/product (1).jpg', 'assets/images/products/product (2).jpg', 'assets/images/products/product (3).jpg'], rating_count: 11, store_rating_count: 11, currency: '$', bought: 567, size: 'M', color: 'Black', shipping: 250, rating: 4, store_rating: 18090, store_rate: 3, sold_by: 'seller', specs: 'this is a sample product', reviews: [{ image: 'assets/images/products/6.jpg', name: 'sample', comment: 'This is an amazing dress and totally out of budget. Need to sell my only kidney to purchase this one as other kidney is already sold for my iphone...lol', rating: 5, images: ['assets/images/products/6.jpg'] }], store_reviews: [{ image: 'assets/images/products/6_1.jpg', name: 'sample', comment: 'This is an amazing dress and totally out of budget. Need to sell my only kidney to purchase this one as other kidney is already sold for my iphone...lol', rating: 5, images: ['assets/images/products/6.jpg', 'assets/images/products/6_1.jpg'] }, { image: 'assets/images/products/6.jpg', name: 'sample', comment: 'This is an amazing dress and totally out of budget. Need to sell my only kidney to purchase this one as other kidney is already sold for my iphone...lol', rating: 5, images: ['assets/images/products/6.jpg'] }], sizing: { small: 10, okay: 80, large: 5 }, buyer_guarantee: 'Return all products within 30 days of delivery if they are not up to your satisfaction', sponsored: [] },
      // { name: 'Morrisson Dress', cost_price: 128, discount: 80, offer: true, stock: 69, description: 'sample data', image: ['assets/images/products/product (1).jpg', 'assets/images/products/product (5).jpg', 'assets/images/products/product (4).jpg'], rating_count: 11, store_rating_count: 11, currency: '$', bought: 137, size: 'M', color: 'Black', shipping: 250, rating: 4, store_rating: 18090, store_rate: 3, sold_by: 'seller', specs: 'this is a sample product', reviews: [{ image: 'assets/images/products/7.jpg', name: 'sample', comment: 'This is an amazing dress and totally out of budget. Need to sell my only kidney to purchase this one as other kidney is already sold for my iphone...lol', rating: 5, images: ['assets/images/products/7.jpg'] }], store_reviews: [{ image: 'assets/images/products/7_1.jpg', name: 'sample', comment: 'This is an amazing dress and totally out of budget. Need to sell my only kidney to purchase this one as other kidney is already sold for my iphone...lol', rating: 5, images: ['assets/images/products/7.jpg', 'assets/images/products/7_1.jpg'] }, { image: 'assets/images/products/7.jpg', name: 'sample', comment: 'This is an amazing dress and totally out of budget. Need to sell my only kidney to purchase this one as other kidney is already sold for my iphone...lol', rating: 5, images: ['assets/images/products/7.jpg'] }], sizing: { small: 10, okay: 80, large: 5 }, buyer_guarantee: 'Return all products within 30 days of delivery if they are not up to your satisfaction', sponsored: [] },
      // { name: 'Smith Dress', cost_price: 98, discount: 80, offer: false, stock: 69, description: 'sample data', image: ['assets/images/products/product (3).jpg', 'assets/images/products/product (3).jpg', 'assets/images/products/product (1).jpg'], rating_count: 11, store_rating_count: 11, currency: '$', bought: 236, size: 'M', color: 'Black', shipping: 250, rating: 4, store_rating: 18090, store_rate: 3, sold_by: 'seller', specs: 'this is a sample product', reviews: [{ image: 'assets/images/products/8.jpg', name: 'sample', comment: 'This is an amazing dress and totally out of budget. Need to sell my only kidney to purchase this one as other kidney is already sold for my iphone...lol', rating: 5, images: ['assets/images/products/8.jpg'] }], store_reviews: [{ image: 'assets/images/products/8.jpg', name: 'sample', comment: 'This is an amazing dress and totally out of budget. Need to sell my only kidney to purchase this one as other kidney is already sold for my iphone...lol', rating: 5, images: ['assets/images/products/8.jpg', 'assets/images/products/8_1.jpg'] }, { image: 'assets/images/products/8.jpg', name: 'sample', comment: 'This is an amazing dress and totally out of budget. Need to sell my only kidney to purchase this one as other kidney is already sold for my iphone...lol', rating: 5, images: ['assets/images/products/8.jpg'] }], sizing: { small: 10, okay: 80, large: 5 }, buyer_guarantee: 'Return all products within 30 days of delivery if they are not up to your satisfaction', sponsored: [] },
      // { name: 'Nicola Dress', cost_price: 278, discount: 80, offer: false, stock: 69, description: 'sample data', image: ['assets/images/products/product (3).jpg', 'assets/images/products/product (4).jpg', 'assets/images/products/product (1).jpg'], rating_count: 11, store_rating_count: 11, currency: '$', bought: 982, size: 'M', color: 'Black', shipping: 250, rating: 4, store_rating: 18090, store_rate: 3, sold_by: 'seller', specs: 'this is a sample product', reviews: [{ image: 'assets/images/products/9.jpg', name: 'sample', comment: 'This is an amazing dress and totally out of budget. Need to sell my only kidney to purchase this one as other kidney is already sold for my iphone...lol', rating: 5, images: ['assets/images/products/9.jpg'] }], store_reviews: [{ image: 'assets/images/products/9_2.jpg', name: 'sample', comment: 'This is an amazing dress and totally out of budget. Need to sell my only kidney to purchase this one as other kidney is already sold for my iphone...lol', rating: 5, images: ['assets/images/products/9.jpg', 'assets/images/products/9_1.jpg'] }, { image: 'assets/images/products/9.jpg', name: 'sample', comment: 'This is an amazing dress and totally out of budget. Need to sell my only kidney to purchase this one as other kidney is already sold for my iphone...lol', rating: 5, images: ['assets/images/products/9.jpg'] }], sizing: { small: 10, okay: 80, large: 5 }, buyer_guarantee: 'Return all products within 30 days of delivery if they are not up to your satisfaction', sponsored: [] },
      // { name: 'Smith Dress', cost_price: 98, discount: 80, offer: true, stock: 69, description: 'sample data', image: ['assets/images/products/product (5).jpg', 'assets/images/products/product (5).jpg', 'assets/images/products/product (1).jpg'], rating_count: 11, store_rating_count: 11, currency: '$', bought: 214, size: 'M', color: 'Black', shipping: 250, rating: 4, store_rating: 18090, store_rate: 3, sold_by: 'seller', specs: 'this is a sample product', reviews: [{ image: 'assets/images/products/10.jpg', name: 'sample', comment: 'This is an amazing dress and totally out of budget. Need to sell my only kidney to purchase this one as other kidney is already sold for my iphone...lol', rating: 5, images: ['assets/images/products/10.jpg'] }], store_reviews: [{ image: 'assets/images/products/10_1.jpg', name: 'sample', comment: 'This is an amazing dress and totally out of budget. Need to sell my only kidney to purchase this one as other kidney is already sold for my iphone...lol', rating: 5, images: ['assets/images/products/10.jpg', 'assets/images/products/10_1.jpg'] }, { image: 'assets/images/products/10.jpg', name: 'sample', comment: 'This is an amazing dress and totally out of budget. Need to sell my only kidney to purchase this one as other kidney is already sold for my iphone...lol', rating: 5, images: ['assets/images/products/10.jpg'] }], sizing: { small: 10, okay: 80, large: 5 }, buyer_guarantee: 'Return all products within 30 days of delivery if they are not up to your satisfaction', sponsored: [] },
      // ];
      ...
      this.faqs = {
        'Get To Know Kuick Save': [{
          'Get To Know Kuick Save?': 'You wanted something simpler, so we made it. A small team of problem solvers, designers, thinkers , work around the clock to make online Battery ordering easy, fast and safe. Kuick save is on its way to become the most powerful online Battery ordering and delivery service in Pakistan. kuick Save has its own logistics management system which is specifically designed for e-commerce operations, and for quick and safe delivery . The service is available in Lahore, Islamabad, Rawalpindi, Faisalabad, Peshawar, kohat and Sargodha.'
        }, {
          'Kuick save is on its way ?': 'Kuick save is on its way to become the most powerful online Battery ordering and delivery service in Pakistan. kuick Save has its own logistics management system which is specifically designed for e-commerce operations, and for quick and safe delivery . The service is available in Lahore, Islamabad, Rawalpindi, Faisalabad, Peshawar, kohat and Sargodha.'
        }],
        'Choose Kuick Save': [{
          'Why Choose Kuick Save?': 'Staying in the office and have no time Too lazy to shopping out? UPS battery if not working then battery for solar panels is there Looking for car/generator battery Kuick Save has online store with variety Simpaly enter your area and search for a Registered shop.'
        }, {
          'Kuick Save Index?': 'The Kuick Save index also includes address and delivery hours so you are never mislead. Kuick Save App makes it all the more easy! Browse the menu on your smart phone, select, check-out and go ! The delivery arrives in time.'
        }]
      };
    };
  ...
  function srcAppFunctionsServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var FunctionsService = /*#__PURE__*/function () {
      ...
      _createClass(FunctionsService, [{
        ...
        key: "update",
        value: function update(product) {// this.dataService.current_product = product;
        }
      }, {
        key: "removeConform",
  ...
  /***/
  "./src/app/infomodal/infomodal.page.scss":
  /*!***********************************************!*\
    !*** ./src/app/infomodal/infomodal.page.scss ***!
    \***********************************************/
  ...
  /***/
  function srcAppInfomodalInfomodalPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = ".textSection {\n  text-align: justify;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  /***/
  function srcAppInfomodalInfomodalPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var InfomodalPage = /*#__PURE__*/function () {
      function InfomodalPage(modalController, params) {
    ...
    InfomodalPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./infomodal.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/infomodal/infomodal.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./infomodal.page.scss */
      "./src/app/infomodal/infomodal.page.scss"))["default"]]
    })], InfomodalPage);
    /***/
  },
  ...
  function srcAppServicesSharedServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var SharedService = /*#__PURE__*/function (_base_service__WEBPAC) {
      _inherits(SharedService, _base_service__WEBPAC);

      var _super = _createSuper(SharedService);
      ...
      function SharedService(http) {
        ...
        _this4.http = http;
        _this4.authenticationState = new rxjs__WEBPACK_IMPORTED_MODULE_4__["BehaviorSubject"](false);
      ...
      _createClass(SharedService, [{
        key: "updatelogin",
        value: function updatelogin(value) {
        ...
        value: function UpdateUser(data) {
          this.user = data;
          if (data.RoleName == 'SuperAdmin') this.appPages = [{
            title: 'Dashboard',
          ...
          }, // { title: 'Notifications', url: '/notification', icon: 'notifications' },
          {
            ...
            title: 'Riders',
            url: '/superadmin/rider',
            icon: 'bicycle-outline'
          }, {
            title: 'Earning',
            url: '/superadmin/earning',
            icon: 'cash'
          }, {
            title: 'Users',
            url: '/superadmin/user',
            ...
            title: 'Orders',
            url: '/superadmin/view-orders',
            icon: 'newspaper-outline'
          }, {
            title: 'Return Products',
            url: '/superadmin/return-product',
            icon: 'duplicate-outline'
          }];
          if (data.RoleName == 'ShopOwner') this.appPages = [{
            title: 'Dashboard',
            url: '/shopowner/dashboard',
            icon: 'apps'
          }, // { title: 'Search', url: '/search', modal: true, icon: 'search' },
          // { title: 'Notifications', url: '/notification', icon: 'notifications' },
          {
            ...
            title: 'Product List',
            url: '/shopowner/list-of-product',
            icon: 'medkit-outline'
          }, {
            title: 'New Orders',
            url: '/shopowner/order/new',
            icon: 'duplicate-outline'
          }, {
            title: 'Pending Orders',
            url: '/shopowner/order/pending',
            icon: 'newspaper-outline'
          }, {
            title: 'Completed Orders',
            url: '/shopowner/order/complete',
            icon: 'checkmark-done-circle-outline'
          }, {
            title: 'Cancelled Orders',
            url: '/shopowner/order/cancel',
            icon: 'close-circle-outline'
          }];
          if (data.RoleName == 'Rider') this.appPages = [{
            title: 'Dashboard',
            url: '/rider/dashboard',
            icon: 'apps'
          }, {
            ...
            title: 'Pending Orders',
            url: '/rider/orders/pending',
            icon: 'newspaper-outline'
          }, {
            title: 'Complete Orders',
            url: '/rider/orders/completed',
            icon: 'checkmark-done-circle-outline'
          }];
          if (data.RoleName == 'Customer') this.appPages = [{
            title: 'Dashboard',
            url: '/home',
            icon: 'apps'
          }, {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! D:\gitkuicksave\multistore-mobile-app\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
