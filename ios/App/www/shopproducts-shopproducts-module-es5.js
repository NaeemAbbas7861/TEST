...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["shopproducts-shopproducts-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppShopproductsShopproductsPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppShopproductsShopproductsModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ShopProductsPageModule", function () {
    ...
    var _shopproducts_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./shopproducts.page */
    "./src/app/shopproducts/shopproducts.page.ts");
    /* harmony import */


    var _productlist_productlist_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    var ShopProductsPageModule = function ShopProductsPageModule() {
      _classCallCheck(this, ShopProductsPageModule);
    };

    ShopProductsPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppShopproductsShopproductsPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppShopproductsShopproductsPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ShopProductsPage", function () {
    ...
    var ShopProductsPage = /*#__PURE__*/function () {
      function ShopProductsPage(activatedRoute, menuCtrl, alertController, nav, fun, dataService, shopservice, route, loadingController, toastService, storage) {
        _classCallCheck(this, ShopProductsPage);
        ...
        this.data = dataService.tabs; // this.product_data_2 = dataService.products_2;
              ...
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    ...
                    this.GetShopProducts(id); // this.storage.set("ShopId" , id);

                    this.storage.get("ShopId").then(function (value) {
                        ...
                        return regeneratorRuntime.wrap(function _callee2$(_context2) {
                          while (1) {
                            switch (_context2.prev = _context2.next) {
                              case 0:
                                console.log(value);
                                if (value == null) this.storage.set("ShopId", id);else if (id != value) {
                                              ...
                                              return this.alertController.create({
                                                ...
                                                buttons: [{
                                                  ...
                                                  handler: function handler() {
                                                    ...
                                                    _this3.storage.remove('Cart');

                                                    _this3.storage.remove('TotalAmount');

                                                    _this3.storage.set("ShopId", id);
                                                  }
                                                }, {
                                                  text: 'Cancel',
                                                  role: 'cancel',
                  ...
                  case 5:
                    ...
                    return this.shopservice.GetShopProducts(id).subscribe(function (res) {
                      ...
                      if (res) {
                        // console.log(res);
                        _this5.shop = res;
                        _this5.products = _this5.shop.products.filter(function (x) {
                          return x.quantity > 0;
                        });
                        console.log(res);

                        if (_this5.products.length < 1) {
                          _this5.NotFound = true;
                        } else {
                          _this5.NotFound = false;
                        }

                        _this5.storage.set("isReturnable", _this5.shop.isReturnable);

                        console.log(_this5.shop.isReturnable);
                      } else {
                        loading.dismiss();
    ...
    ShopProductsPage.ctorParameters = function () {
      return [{
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('Slides')], ShopProductsPage.prototype, "slides", void 0);
    ShopProductsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-shopproducts',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./shopproducts.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/shopproducts/shopproducts.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./shopproducts.page.scss */
      "./src/app/shopproducts/shopproducts.page.scss"))["default"]]
    })], ShopProductsPage);
    /***/
  }
}]);
//# sourceMappingURL=shopproducts-shopproducts-module-es5.js.map