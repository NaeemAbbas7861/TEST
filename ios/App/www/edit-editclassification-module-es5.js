...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["edit-editclassification-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppSuperAdminGroupCategoryClassificationEditEditclassificationPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppSuperAdminGroupCategoryClassificationEditEditclassificationModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EditClassificationPageModule", function () {
      return EditClassificationPageModule;
    });
    /* harmony import */
    ...
    var _editclassification_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./editclassification.page */
    ...
    var EditClassificationPageModule = function EditClassificationPageModule() {
      _classCallCheck(this, EditClassificationPageModule);
    };

    EditClassificationPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppSuperAdminGroupCategoryClassificationEditEditclassificationPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppSuperAdminGroupCategoryClassificationEditEditclassificationPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EditClassificationPage", function () {
      return EditClassificationPage;
    });
    /* harmony import */
    ...
    var EditClassificationPage = /*#__PURE__*/function () {
      function EditClassificationPage(router, route, classificationservice, loadingController, toastService, formBuilder, http // private imagePicker: ImagePicker
      ) {
        _classCallCheck(this, EditClassificationPage);
      ...
      _createClass(EditClassificationPage, [{
        key: "ngOnInit",
        ...
        value: function getclassification(id) {
            ...
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 5:
                    _context2.next = 7;
                    return this.classificationservice.GetSingleclassification(id).subscribe(function (res) {
                      loading.dismiss();

                      if (res) {
                        console.log(res);
                        _this.classification = res;

                        _this.fg.controls['Id'].setValue(_this.classification.id);

                        _this.fg.controls['Name'].setValue(_this.classification.name);

                        _this.fg.controls['Description'].setValue(_this.classification.description);

                        _this.fg.controls['Thumbnail'].setValue(_this.classification.thumbnail);

                        _this.fg.controls['Banner'].setValue(_this.classification.banner); //  this.ngOnInit();
        ...
        value: function EditClassification() {
            ...
            return regeneratorRuntime.wrap(function _callee3$(_context3) {
              while (1) {
                switch (_context3.prev = _context3.next) {
                  ...
                  case 12:
                    _context3.next = 14;
                    return this.classificationservice.Editclassification(this.id2, this.fg.value).subscribe(function (res) {
                      loading.dismiss();

                      _this2.toastService.create("Successfully Updated", "success");

                      _this2.router.navigate(['./superadmin/group/' + _this2.id + '/category/' + _this2.id1 + '/classification']);
                    }, function (err) {
                      loading.dismiss();
    ...
    EditClassificationPage.ctorParameters = function () {
      return [{
    ...
    EditClassificationPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-editclassification',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./editclassification.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/superAdmin/group/category/classification/edit/editclassification.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./editclassification.page.scss */
      "./src/app/superAdmin/group/category/classification/edit/editclassification.page.scss"))["default"]]
    })], EditClassificationPage);
    /***/
  }
}]);
//# sourceMappingURL=edit-editclassification-module-es5.js.map