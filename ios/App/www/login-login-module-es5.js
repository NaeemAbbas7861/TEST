...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
  ...
  function srcAppLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_services_toast_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! src/app/services/toast.service */
    "./src/app/services/toast.service.ts");
    /* harmony import */


    var jwt_decode__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! jwt-decode */
    "./node_modules/jwt-decode/lib/index.js");
    /* harmony import */


    var jwt_decode__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(jwt_decode__WEBPACK_IMPORTED_MODULE_13__);
    /**
     * Shoppr - E-commerce app starter Ionic 4(https://www.enappd.com)
     *
     * Copyright © 2018-present Enappd. All rights reserved.
    ...
    var LoginPage = /*#__PURE__*/function () {
      function LoginPage(platform, splashScreen, fun, menuCtrl, modalController, data, formBuilder, loginservice, sharedservice, storage, router, toasterservice, loadingController) {
        var _this = this;
      ...
      _createClass(LoginPage, [{
        ...
        value: function ngOnInit() {
          this.fg = this.formBuilder.group({
            'Email_Address': [null, _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].pattern("^[_A-Za-z0-9-\\+]+(\\.[_A-Za-z0-9-]+)*@[A-Za-z0-9-]+(\\.[A-Za-z0-9]+)*(\\.[A-Za-z]{2,})$")])],
        ...
        value: function ionViewWillEnter() {
          ...
          this.storage.get("IsLoggedIn").then(function (value) {
            if (value) _this2.router.navigate(['/home']);
          });
        }
      }, {
        key: "ionViewDidEnter",
        value: function ionViewDidEnter() {
          ...
          this.splashScreen.hide(); // this.fun.navigate('home', false);
        }
      }, {
        key: "togglePassword",
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 5:
                    _context.next = 7;
                    return this.loginservice.Login(this.fg.value).subscribe(function (res) {
                      if (res) {
                        loading.dismiss(); // this.storage.set(environment.USER, res);

                        var user = _this3.getDecodedAccessToken(res.token);

                        _this3.sharedservice.UpdateUser(user);

                        _this3.sharedservice.updatelogin(true);

                        _this3.storage.set("User", user);

                        _this3.storage.set("IsLoggedIn", true);
                      ...
                      if (err.message) {
                        _this3.toasterservice.create(err.message, 'danger');
                      } else if (err.indexOf("unverified") != -1) {
                        var res = err.split("-")[1];

                        _this3.router.navigate(['/otpverify/' + res]);

                        _this3.storage.set("userid", res);
                      } else {
                        console.log(err);

                        _this3.toasterservice.create('Your account is Disabled', 'danger');
                      }
                    });
