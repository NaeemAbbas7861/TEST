...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OtpverifyresetPageModule", function() { return OtpverifyresetPageModule; });
...
/* harmony import */ var _otp_verifyresetpage__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./otp_verifyresetpage */ "./src/app/passwordreset/otp_verify/otp_verifyresetpage.ts");
...
let OtpverifyresetPageModule = class OtpverifyresetPageModule {
};
OtpverifyresetPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OtpverifyresetPage", function() { return OtpverifyresetPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
let OtpverifyresetPage = class OtpverifyresetPage {
    constructor(menuCtrl, loginservice, storage, router, toasterservice, loadingController, route, sharedservice) {
    ...
    verify() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            yield this.loginservice.VerifyReset(this.id, code1)
                .subscribe(res => {
                loading.dismiss();
                console.log(res);
                this.otp = false;
    ...
    UpdatePassword() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            if (this.Password.length < 8) {
                ...
                const loading = yield this.loadingController.create({ message: "Loading" });
                yield loading.present();
                yield this.loginservice.ChangePassword(this.id, data)
                    .subscribe(res => {
                    loading.dismiss();
...
OtpverifyresetPage.ctorParameters = () => [
...
OtpverifyresetPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-passwordreset',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./otp_verify.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/passwordreset/otp_verify/otp_verify.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./otp_verify.page.scss */ "./src/app/passwordreset/otp_verify/otp_verify.page.scss")).default]
    })
], OtpverifyresetPage);
...
//# sourceMappingURL=otp_verify-otp_verifyreset-module-es2015.js.map