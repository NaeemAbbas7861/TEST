...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ShopEarningPageModule", function() { return ShopEarningPageModule; });
...
/* harmony import */ var _shopearning_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./shopearning.page */ "./src/app/superAdmin/shopearning/shopearning.page.ts");
...
let ShopEarningPageModule = class ShopEarningPageModule {
};
ShopEarningPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ShopEarningPage", function() { return ShopEarningPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
let ShopEarningPage = class ShopEarningPage {
    constructor(menuCtrl, nav, platform, loadingController, toastService, orderservice, storage, route, alertController) {
    ...
    GetShopEarning(id, date) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            yield this.orderservice.GetShopEarning(id, date).subscribe(res => {
                loading.dismiss();
                this.earning = res;
    ...
    ChangePaymentStatus(id, status, panelty) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (status == '1') {
                ...
                const loading = yield this.loadingController.create({ message: "Loading" });
                yield loading.present();
                yield this.orderservice.ChangePaymentStatus(id, status, panelty).subscribe(res => {
                    console.log(res);
                    ...
                    buttons: [
                        {
                            ...
                            handler: (alertData) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                                ...
                                const loading = yield this.loadingController.create({ message: "Loading" });
                                yield loading.present();
                                yield this.orderservice.ChangePaymentStatus(id, status, alertData.Panelty1).subscribe(res => {
                                    console.log(res);
                                    loading.dismiss();
...
ShopEarningPage.ctorParameters = () => [
...
ShopEarningPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        selector: 'app-search',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./shopearning.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/superAdmin/shopearning/shopearning.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./shopearning.page.scss */ "./src/app/superAdmin/shopearning/shopearning.page.scss")).default]
    })
], ShopEarningPage);
...
//# sourceMappingURL=shopearning-shopearning-module-es2015.js.map