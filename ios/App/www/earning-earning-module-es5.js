...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["earning-earning-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppSuperAdminEarningEarningPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppSuperAdminEarningEarningModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var EarningPageModule = function EarningPageModule() {
  ...
  /***/
  function srcAppSuperAdminEarningEarningPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppSuperAdminEarningEarningPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var EarningPage = /*#__PURE__*/function () {
      function EarningPage(menuCtrl, nav, platform, loadingController, orderservice, download, toastService) {
        var _this = this;
        ...
        this.API_EARNING = "".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["environment"].BASE_URL);
        this.platform.ready().then(function () {
          var date = new Date();
          date.setDate(date.getDate() - 731);
          _this.minDate = date.toISOString(); // date.setDate(1);

          date = new Date();
          date.setDate(date.getDate() + 0);
          _this.maxDate = date.toISOString(); // date.setDate(1);
        });
      }

      _createClass(EarningPage, [{
        key: "ngOnInit",
        value: function ngOnInit() {// this.date= new Date();
          // this.date.setDate(1);
        ...
        key: "getEarning",
        value: function getEarning(date, selectDateString1) {
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 12:
                    _context.next = 14;
                    return this.orderservice.GetEarningDatetoDate(date, this.selectDateString1).subscribe(function (res) {
        ...
        value: function DownloadEarningDatetoDate(date1, date2) {
                ...
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    if (date1 > date2) {
                      ...
                      request = {
                        uri: "".concat(this.API_EARNING, "downloadcsv/").concat(date1, "/").concat(date2),
                        title: 'MyDownload',
                        description: '',
                        mimeType: '',
                      ...
                      this.download.download(request).then(function (location) {
    ...
    EarningPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/superAdmin/earning/earning.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./earning.page.scss */
      "./src/app/superAdmin/earning/earning.page.scss"))["default"]]
    })], EarningPage);
    /***/
  }
}]);
