...
/* harmony import */ var _item_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./item.page */ "./src/app/shopOwner/order/items/item.page.ts");
    ...
    GetOrderItems(id) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            yield this.orderservice.GetOrder(id).subscribe(res => {
                loading.dismiss();
                if (res) {
                    this.Latitude = res.customerLat;
                    this.Longitude = res.customerLong;
                    console.log(res);
                    this.items = res;
                    console.warn(res);
                    this.loadMap();
...
ItemsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./item.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/shopOwner/order/items/item.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./item.page.scss */ "./src/app/shopOwner/order/items/item.page.scss")).default]
    })
], ItemsPage);
...
//# sourceMappingURL=items-item-module-es2015.js.map