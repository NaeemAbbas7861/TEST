...
export class SharedService extends BaseService {
  ...
  user:any = {RoleName: 'Customer' , FirstName: "Guest" , LastName: "User"};
   public appPages = [
    ...
    { title: 'Wishlist', url: '/wishlist', icon: 'heart-outline' },
...
this.isloggedin = value;
  ...
  UpdateUser(data) {
    ...
    this.appPages=[
      ...
      { title: 'Category', url: '/superadmin/group', icon: 'logo-buffer' },
      ...
      { title: 'Return Products', url:'/superadmin/return-product', icon:'duplicate-outline' },
    ...
    this.appPages=[
      ...
      { title: 'Cancelled Orders', url: '/shopowner/order/cancel', icon: 'close-circle-outline' },
